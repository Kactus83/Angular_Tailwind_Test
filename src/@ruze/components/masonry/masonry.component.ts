...
import { RuzeMediaWatcherService } from '../../services/media-watcher';

@Component({
    selector     : 'ruze-masonry',
    templateUrl  : './masonry.component.html',
    encapsulation: ViewEncapsulation.None,
    animations   : ruzeAnimations,
    exportAs     : 'ruzeMasonry'
})
export class RuzeMasonryComponent implements OnChanges, AfterViewInit
{
