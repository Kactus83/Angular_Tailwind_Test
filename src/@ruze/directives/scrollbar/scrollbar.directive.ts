 ...
 */
@Directive({
    selector: '[ruzeScrollbar]',
    exportAs: 'ruzeScrollbar'
})
export class RuzeScrollbarDirective implements OnChanges, OnInit, OnDestroy
{
    /* eslint-disable @typescript-eslint/naming-convention */
    static ngAcceptInputType_ruzeScrollbar: BooleanInput;
    /* eslint-enable @typescript-eslint/naming-convention */

    @Input() ruzeScrollbar: boolean = true;
    @Input() ruzeScrollbarOptions: PerfectScrollbar.Options;
    ...
    {
        // Enabled
        if ( 'ruzeScrollbar' in changes )
        {
            // Interpret empty string as 'true'
            this.ruzeScrollbar = coerceBooleanProperty(changes['ruzeScrollbar'].currentValue);

            // If enabled, init the directive
            if ( this.ruzeScrollbar )
            {
                this._init();
            }
        ...
        // Scrollbar options
        if ( 'ruzeScrollbarOptions' in changes )
        {
            // Merge the options
            this._options = merge({}, this._options, changes['ruzeScrollbarOptions'].currentValue);
