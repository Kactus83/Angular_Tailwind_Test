...
import { RuzeMockApiReplyCallback } from './mock-api.types';
import { Observable, of, take, throwError } from 'rxjs';

export class RuzeMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: RuzeMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: RuzeMockApiReplyCallback): void
    {
        // Store the reply
