...
import { RuzeMockApiUtils } from '../../../../../@ruze/lib/mock-api/mock-api.utils';
import { RuzeMockApiService } from '../../../../../@ruze/lib/mock-api/mock-api.service';
import { brands as brandsData, categories as categoriesData, products as productsData, tags as tagsData, vendors as vendorsData } from '../../../../mock-api/apps/ecommerce/inventory/data';
    ...
    registerHandlers(): void
    {
        ...
        this._ruzeMockApiService
            ...
            .reply(({request}) =>
            {
                ...
                // Generate a new GUID
                newTag.id = RuzeMockApiUtils.guid();
