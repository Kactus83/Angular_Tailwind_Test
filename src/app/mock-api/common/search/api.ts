...
import { RuzeNavigationService } from '../../../../@ruze/components/navigation/navigation.service';
import { RuzeNavigationItem } from '../../../../@ruze/components/navigation/navigation.types';
import { RuzeMockApiService } from '../../../../@ruze/lib/mock-api/mock-api.service';
import { contacts } from '../../../mock-api/apps/contacts/data';
...
export class SearchMockApi
{
     ...
     */
    constructor(
        private _ruzeMockApiService: RuzeMockApiService,
    ...
    registerHandlers(): void
    {
        ...
        const flatNavigation = this._ruzeNavigationService.getFlatNavigation(this._defaultNavigation);
